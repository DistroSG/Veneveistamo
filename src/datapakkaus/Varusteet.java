...
public class Varusteet {
    ...
    private final double alv;
        ...
        public Varusteet(int id, String kuvaus, String kuva, int takuu_id, double hinta, double alv) {
        this.id = id;
        this.kuvaus = kuvaus;
        this.kuva = kuva;
  ...
  public String toString() {
        return "varusteet{" + "id=" + id + ", kuvaus=" + kuvaus + ", kuva=" + kuva + ", takuu_id=" + takuu_id + ", hinta=" + hinta + ", alv=" + alv + '}';
    }
}